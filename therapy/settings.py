...
SECRET_KEY = 'django-insecure-e7k6_%v9yzf4^a2@r7np^-eze9(tkd*y)o_#k!#p3&93e4e*wm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['healerkim.se', '*']
...
EMAIL_HOST_PASSWORD = "xnxknhzheojrtajs"